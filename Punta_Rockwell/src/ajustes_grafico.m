...
% co(1,1:3) = [12/255 237/255 188/255];
% co(2,1:3) = [76/255 12/255 237/255];
% co(3,1:3) = [173/255 237/255 12/255];
% co(4,1:3) = [237/255 12/255 61/255];

% opcion 1
co(1,1:3) = [55 126 184]/255;
co(2,1:3) = [77 175 74]/255;
co(3,1:3) = [152 78 163]/255;
co(4,1:3) = [228 26 28]/255;
% opcion 2
% co(1,1:3) = [0 0.4 0.9];
% co(2,1:3) = [0 0.75 0];
% co(3,1:3) = [0.9 0.9 0];
% co(4,1:3) = [0.75 0.1 0.1];
